                ...
                <div className="drawer-content flex flex-col">
                    <div className="w-full navbar bg-base-100 lg:px-20 fixed top-0 z-50">
                      ...
                      {pathname.includes("dashboard") &&
                          <label tabIndex="0" htmlFor="dashboard-drawer" className="btn btn-ghost btn-circle lg:hidden md:block sm:block">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                        </label>}


                        <div className="flex-1 px-2 mx-2 font-bold uppercase">Swipe Cleaning Co.</div>
